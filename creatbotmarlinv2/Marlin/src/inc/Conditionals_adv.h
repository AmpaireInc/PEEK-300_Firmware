...
#if ENABLED(USB_FLASH_DRIVE_SUPPORT) && NONE(USE_OTG_USB_HOST, USE_UHS3_USB, USE_CH376)
  #define USE_UHS2_USB
#endif
 ...
 */
    ...
    #elif MB(CREALITY_V24S1_301, CREALITY_V24S1_301F4, CREALITY_V423, MKS_ROBIN, CREATBOT_V1_0, CREATBOT_V2_0)
      #define LCD_SERIAL_PORT 2 // Creality Ender3S1, MKS Robin, CreatBot F446
    #else
