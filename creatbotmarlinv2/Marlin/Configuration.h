...
#define STRING_CONFIG_H_AUTHOR "(Ampaire-Joshua, PEEK-300 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CreatBot PEEK-300"
...
#define SWITCHING_NOZZLE
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES { 30, 150 } // Angles for E0, E1 (single servo) or lowered/raised (dual servo)
...
//#define PSU_NAME "Power Supply"
  ...
  #define AUTO_POWER_CONTROL        // Enable automatic control of the PS_ON pin
    ...
    #define AUTO_POWER_E_TEMP         100 // (°C) PSU on if any extruder is over this temperature
...
#define HEATER_0_MAXTEMP 495
#define HEATER_1_MAXTEMP 495
...
#define BED_MAXTEMP      210
#define CHAMBER_MAXTEMP  130
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  9.39,  9.39 }
    #define DEFAULT_Ki_LIST {   0.47,   0.47 }
    #define DEFAULT_Kd_LIST { 48.30, 48.30 }
  #else
    #define DEFAULT_Kp  9.39
    #define DEFAULT_Ki  0.47
    #define DEFAULT_Kd  48.30
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 62.64
  #define DEFAULT_bedKi 12.05
  #define DEFAULT_bedKd 217.14
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  //
  #define DEFAULT_chamberKp 30.68
  #define DEFAULT_chamberKi 0.21
  #define DEFAULT_chamberKd 0
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2000, 360, 360 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 6, 40, 40 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 10, 3000, 3000 }
...
#define Z_SERVO_ANGLES { 75, 105 } // Z Servo Deploy and Stow angles
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 1 //25
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE         50    // (mm/s) Feedrate for G26 XY moves.
