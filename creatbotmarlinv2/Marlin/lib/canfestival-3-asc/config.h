...
#define DRIVER_USE_SERIAL
// #define DRIVER_USE_CAN

#if defined(DRIVER_USE_SERIAL) && defined(DRIVER_USE_CAN)
#error "Only one driver mode can be specified!"
#endif

#define MAX_CAN_BUS_ID 1
#define SDO_MAX_LENGTH_TRANSFER 256
#define SDO_BLOCK_SIZE 16
#define SDO_MAX_SIMULTANEOUS_TRANSFERS 4
#define NMT_MAX_NODE_ID 4
